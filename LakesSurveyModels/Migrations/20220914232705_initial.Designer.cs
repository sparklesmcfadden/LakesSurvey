...
namespace LakesSurveyModels.Migrations
{
    ...
    [Migration("20220914232705_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LakesSurveyModels.Models.Lakes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LakesSurveyModels.Models.Fish", b =>
                {
                    b.HasOne("LakesSurveyModels.Models.FishType", "FishType")
                        .WithMany()
                        .HasForeignKey("FishTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LakesSurveyModels.Models.Survey", null)
                        .WithMany("Fish")
